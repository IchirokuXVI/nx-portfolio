...
export const PROJECT_TRANSLATIONS: readonly ProjectTranslation[] = [
  // VR Sickness Reducer
  {
    ...
    tags: [
      { label: 'Platform', value: 'Virtual Reality (VR)' },
      { label: 'Engine', value: 'Unreal Engine 5' },
      { label: 'Sector', value: 'Investigation' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Plataforma', value: 'Realidad Virtual (VR)' },
      { label: 'Motor', value: 'Unreal Engine 5' },
      { label: 'Sector', value: 'Investigación' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Plateforme', value: 'Réalité Virtuelle (VR)' },
      { label: 'Moteur', value: 'Unreal Engine 5' },
      { label: 'Secteur', value: 'Recherche' },
      { label: 'Expérience', value: 'Immersive' },
    ],
  },
