 ...
 *
 * Every unit spec of `BasketService.update` needs one, because the
 ...
 * repository, for the specs of `BasketService.update`.
 *
 ...
 * `manager.findOne(Basket, …)` and `manager.getRepository(Basket)`
 * reach it.
 *
