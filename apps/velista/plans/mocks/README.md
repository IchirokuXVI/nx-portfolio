...
| `nav/`            | `0090` the bar at the bottom of the app                                                                                                          | https://claude.ai/artifact/HSJYUM3oq8srUafnH76P81                    |
| `onboarding/`     | `0091` the setup a new account walks through, with backend `0130` behind it                                                                      | https://claude.ai/artifact/Y3K3PZNGLnEjNUHjfWBDBF                    |
| `tour/`           | `0092` the tour, with backend `0130` behind it                                                                                                   | https://claude.ai/artifact/YbfH7bVn7DGC1MFqWdqNvS                    |
| `catalog/`        | `0093` the catalog tab, with backend `0131` behind it                                                                                            | https://claude.ai/artifact/9UppvQ8HfCVouog2WK7fi7                    |
