...
>
> **Revised by `plans/backlog/0001`, which is not scheduled yet.** That plan makes a line's
...
> unchanged. Until that plan is picked up, this one describes what is built.
