...
const SERVICES = {
  auth: { envDir: 'apps/luna-shopper/auth', urlVar: 'AUTH_DB_URL' },
  core: { envDir: 'apps/luna-shopper/core', urlVar: 'CORE_DB_URL' },
  catalog: { envDir: 'apps/luna-shopper/catalog', urlVar: 'CATALOG_DB_URL' },
};
